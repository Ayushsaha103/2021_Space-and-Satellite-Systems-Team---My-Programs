# THIS IS VERSION 2 (READING THE INPUTS FROM TWO .XLS FILES)
...
JD_tt = 0.1
wb2 = xlrd.open_workbook("mop_moon_jd_lookup_as_xls.xls")
mop_moon_jd_lookup = wb2.sheet_by_index(0)
#print(mop_moon_jd_lookup.cell_value(11, 0))


# Opening other data file (xls format)
...
list_end = mop_moon_jd_lookup.nrows - 1
#print(mop_moon_jd_lookup.cell_value(list_end, 0))
if JD_tt > mop_moon_jd_lookup.cell_value(list_end, 0):
...
for i in range(1,list_end+1):
    #print(i)
    if JD_tt >= mop_moon_jd_lookup.cell_value(i-1, 0) and JD_tt <= mop_moon_jd_lookup.cell_value(i, 0):
        k = i
        f = (JD_tt - mop_moon_jd_lookup.cell_value(i-1, 0)) / (mop_moon_jd_lookup.cell_value(i, 0) - mop_moon_jd_lookup.cell_value(i-1, 0))
        break
