function moon_eci   = calc_moon_pos(JD_tt, mop_moon_eph_coeff, mop_moon_jd_lookup)
...
moon_eci =[0;0;0];
moon_eci(1) = 1000*dot(coeff_x, y);
moon_eci(2) = 1000*dot(coeff_y, y);
moon_eci(3) = 1000*dot(coeff_z, y);
end