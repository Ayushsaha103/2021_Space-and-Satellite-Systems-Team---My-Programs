...
# Program-crash-detection-and-response algorithm equipped (fixation requires < 1.5sec)
...
time_change_rate = 0.1                 # You may adjust me! (the big while loop runs once per time_change_rate * (1sec))
                                    ...
                                    #val is basically angular momentum constant
val = 0.01                           # You may adjust me! (just make sure to adjust all 3 of em)
main_val_value_positive = 0.01
main_val_value_negative = -0.01

                            # the t upper and lower bounds mark where (at what t value) the deceleration and acceleration start/end
